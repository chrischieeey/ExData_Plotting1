##Plot1.R
##Histogram (Frequency) of Global Active Power in Kilowatts
##--------------------------------------------------------------
...
#0: Check if data and plot exists
        ...
        } else if(file.exists("Plot1.png")) {
                stop("Congratulations, Plot1.png already exists.")
        }       
...
#4: Create chart and PNG file
        hist(Tidy_data$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (in kilowatts)", ylab = "Frequency", col = "Red")
